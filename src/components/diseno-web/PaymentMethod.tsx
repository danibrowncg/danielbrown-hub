  ...
  return (
    <section className="relative overflow-hidden px-5 py-20 sm:px-8 lg:px-16 lg:py-28">
      <div className="mx-auto max-w-5xl">
        <Reveal>
          <p className="text-xs font-semibold uppercase tracking-[0.3em] text-brand-deep">Forma de pago</p>
        </Reveal>
        <Reveal delay={0.1}>
        ...
        <div className="relative mt-12 grid gap-6 sm:grid-cols-2">
          ...
          {steps.map((s, i) => (
            ...
            >
              <div className="font-display text-6xl text-brand-deep/25">{s.n}</div>
        ...
        <Reveal delay={0.3} className="mt-10 flex flex-col items-center gap-2 text-center">
          <p className="inline-flex items-center gap-2 font-display text-2xl uppercase text-brand-deep sm:text-3xl"><ShieldCheck className="h-7 w-7" strokeWidth={2} /> Satisfacción garantizada</p>
