      ...
      <div className="relative mx-auto max-w-3xl text-center">
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            className="inline-flex h-14 items-center justify-center gap-3 rounded-full bg-neon px-9 text-base font-bold uppercase tracking-wider text-ink sm:h-16 sm:px-12 sm:text-lg"
