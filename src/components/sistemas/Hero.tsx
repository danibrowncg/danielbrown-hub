  ...
  return (
    ...
    >
        ...
        >
          ...
          >
            <ArrowLeft
              ...
              strokeWidth={2.5}
            />
            Daniel Brown<span className="text-ink">.</span>
          </Link>
        </motion.div>
        <motion.div
          ...
          className="relative z-10 h-12 w-12 overflow-hidden rounded-full ring-2 ring-ink/60"
      ...
      >
        ...
        Desarrollo 1-2 semanas · Soluciones custom
      </motion.div>
      ...
      <motion.div style={scrollStyle} className="relative z-10 mt-6 flex-1">
        ...
        >
          Automatización inteligente y soluciones custom con IA para tu empresa.
          Transforma procesos, optimiza tiempos y escala resultados reales.
        </motion.p>
