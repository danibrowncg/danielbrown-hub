  ...
  return (
    <main className="relative isolate z-10 flex min-h-[100dvh] flex-col items-center justify-center px-5 py-14 text-ink">
      <div className="relative z-10 flex w-full max-w-[26rem] flex-col items-center">
        ...
        <motion.div
          {...fadeUp(0.1)}
          className="mt-5 inline-flex items-center gap-2 rounded-full bg-ink px-3.5 py-1.5 text-[11px] font-semibold uppercase tracking-widest text-neon shadow-[0_8px_24px_-12px_rgba(13,0,38,0.5)]"
        >
